...
var min_player_bounds: Vector2
var max_player_bounds: Vector2
...
func _process(delta):
	...
	position = _calulate_new_position(velocity, delta)
...
func _calulate_new_position(velocity: Vector2, delta: float):
